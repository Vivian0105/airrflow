...
The estimated running time is 15 minutes. We have also provided the [results on Zenodo](https://zenodo.org/records/20450474) in case you do not have enough time to run the pipeline yourself.
